...
export default function PricingPage() {
  ...
  const bannerText = 'Save 25% on Annual Subcription';

  return (
    <div
      className={cn('flex flex-col w-full items-center mt-48', styles.fancyOverlay)}
    >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          <div className="w-full lg:w-auto mx-auto max-w-4xl lg:text-center">
            ...
            <p className="text-black dark:text-white mt-6 md:text-xl lg:text-center max-w-prose">
              Empower your customer experience with AI-driven content generation. Our tiered plans offer a range of features and usage volumes to perfectly align with the size and goals of your bank.
            </p>
          </div>

          {bannerText ? (
            <div className="w-full lg:w-auto flex justify-center my-4">
              <p className="w-full px-4 py-3 text-sm font-semibold bg-sky-300 text-black dark:bg-sky-300/30 dark:text-white/80 rounded-xl">
                {bannerText}
              </p>
            </div>
          ) : null}
