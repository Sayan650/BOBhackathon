...
const ReverseManifesto: React.FC<ManifestoProps> = ({ candidateName, manifestoTitle, points, imageUrl }) => {
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 max-w-6xl mx-auto my-10 flex items-center">
      ...
      <div className="ml-10 w-full md:w-2/3 pr-8">
...
export default ReverseManifesto;
